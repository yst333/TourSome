                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="/membership/modify" method="post" role="form">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="id" name="id"
                                        placeholder="Id" value="${session.id}">
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user"
                                            id="password" name="password" placeholder="password" value="${session.password}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control form-control-user" id="email" name="email"
                                        placeholder="E-mail" value="${session.email}">
                                </div>
                                <div class="form-group row">
	                                <div class="col-sm-6 mb-3 mb-sm-0">
	                                ...
	                                <div class="col-sm-6 mb-3 mb-sm-0">
	                                    <input type="text" class="form-control form-control-user" id="p_num" name="p_num"
	                                        placeholder="Moblie" value="${session.p_num}">
	                                </div>
                                </div>
                                <div class="form-group">
	                                <div class="col-sm-6 mb-3 mb-sm-0">
									...
									<div class="col-sm-6 mb-3 mb-sm-0">
									    ...
									    <input type="text" class="bar2 form-control form-control-user" id="address2" value="${session.address}" name="address2" placeholder="Address" style="width: 410px;" required><br>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-3 mb-8 mb-sm-0" style="padding-left: 30px; padding-top: 1em;" >
											<input class="form-check-input" type="radio" name="gender" value="M" <c:out value="${session.gender.toString() == 'M' ? 'checked':''}" />>
										...
										<div class="col-sm-3 mb-3 mb-sm-0" style="padding-left: 30px; padding-top: 1em;">
										    <input class="form-check-input" type="radio" name="gender" value="F" <c:out value="${session.gender.toString() == 'F' ? 'checked':''}" />>
										    <label class="form-check-label" for="flexRadioDisabled">Women</label> 
									    </div>
										<div class="col-sm-6 mb-3 mb-sm-0">
											<input class="form-control form-control-user" type="number" name="age" placeholder="Age" value="${session.age}">
										</div>
									</div>
                                </div>
                                <div class="form-group">
	                                <a href="/membership/modify" class="btn btn-primary btn-user btn-block modify_btn">Modify Account </a>
	                                <hr>
                                </div>
                                <!-- 
