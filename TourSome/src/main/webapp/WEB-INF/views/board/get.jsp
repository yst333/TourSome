      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <div class="form-group">
               ...
               <input class="form-control" name="replyer" value="${session.id}" readonly>
            </div>
            <div class="form-group">
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
      ...
      function showList(page){
         ...
         replyService.getList({bno:bnoValue, page : page||1},function(replyCnt, list){
            ...
            // Page441 아래 1줄 showReplyPage() 메소드 소스 추가 코딩
   ...
   //페이지의 번호를 클릭했을 때 새로운 댓글을 가져오도록 합니다. 
   	replyPageFooter.on("click", "li a", function(e) {
        ...
        e.preventDefault();
   		...
   		console.log("targetaPageNum = " + targetPageNum);
   ...
   var modal = $(".modal");
    ...
    $("#addReplyBtn").on("click",function(e){
       ...
       $(".modal").modal("show");
       modal.find("input[name='replyer']").val("<c:out value="${session.id}" />");
    });
    ...
    modalRegisterBtn.on("click",function(e){
       ...
       // 댓글이 정상적으로 추가되면 경고창(alert)을 이용해서 성공했다는 사실을 알려주고,
        ...
        replyService.add(reply, function(result){
           ...
           //showList(1); // 댓글 리스크 갱신처리하고 1페이지로 리턴처리하는 역할을 함
           showList(-1);
    ...
    modalModBtn.on("click", function (e) {
		...
		replyService.update(reply, function (result) {
			...
			//showList(1); // 댓글 리스크 갱신처리하고 1페이지로 리턴처리하는 역할을 함
			// Page 442 페이징이 적용된 댓글을 수정할 때, 현재 보고 있는 댓글 페이지의 번호를 호출
			showList(pageNum);
		});
	});
